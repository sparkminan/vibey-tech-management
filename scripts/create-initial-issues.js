...
- セキュリティガイド: [QUALITY_IMPROVEMENT_GUIDE.md](../QUALITY_IMPROVEMENT_GUIDE.md)
...
## 👥 ステークホルダー
- **プロダクトオーナー**: sparkさん
- **開発チーム**: Claude Code Remote, HENKAKU AI Archive
- **エンドユーザー**: チーム全体・外部協力者
...
| リスク | 影響度 | 対策 |
|-------|-------|------|
| チーム適応遅延 | 中 | 段階的導入・継続サポート |
| 既存ワークフロー変更抵抗 | 中 | メリット明示・柔軟対応 |
| GitHub機能制限 | 低 | 代替手段準備 |
...
if (require.main === module) {
  ...
  createInitialIssues().catch(console.error);
}

module.exports = { createInitialIssues };